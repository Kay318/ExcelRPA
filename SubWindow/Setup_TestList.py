...
class Setup_TestList(QDialog):
    ...
    def setupUI_TestList(self):
        ...
        self.set_QWidget = QWidget(self)
        self.set_QWidget.setObjectName("set_QWidget")
        self.addTest_Button = QPushButton(self)
        ...
        self.add_btn_QWidget = QWidget(self)
        self.set_btn_QWidget = QWidget(self)
        ...
        self.resize(400, 400)
        self.addTest_Button.setGeometry(QRect(150, 10, 101, 41))
        self.add_btn_QWidget.setGeometry(QRect(150, 10, 101, 41))
        self.set_QWidget.setGeometry(QRect(20, 70, 361, 241))
        self.set_btn_QWidget.setGeometry(QRect(220, 317, 161, 41))
        self.ok_Button.setGeometry(QRect(1, 3, 76, 23))
        self.cancel_Button.setGeometry(QRect(83, 3, 76, 23))
        self.TestList_scrollAreaWidgetContents.setGeometry(QRect(20, 70, 361, 241))
